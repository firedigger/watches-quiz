...
export class GameService {
    watches: Watches[] = [
        ...
        { pic: 'assets/watches/watch15.jpg', price: 28.69, brand: 'Forsining', model: 'Fashion Steampunk Black Dial Automatic Skeleton Relogio', link: 'https://www.temu.com/fi-en/forsining-fashion-steampunk-black-dial-mens-automatic-mechanical-watch-waterproof-skeleton-wristwatches-g-601099530538947.html' },
        { pic: 'assets/watches/watch14.jpg', price: 32.88, brand: 'NAVIFORCE', model: 'Quartz Stainless Steel Luminous', link: 'https://www.temu.com/fi-en/naviforce-multifunctional-mens-luxury-sports-quartz-watch-stainless-steel-band-waterproof-luminous-electronic-watch-g-601099548515264.html' },
        ...
        { pic: 'assets/watches/watch1.jpg', price: 14.55, brand: 'LIGE', model: 'Business Fashion PU Leather Wrist', link: 'https://www.temu.com/fi-en/1pc--mens-watch-luxury-leather-waterproof-sport-quartz-wristwatch-chronograph-military-watch-for-men-g-601099513674164.html' },
